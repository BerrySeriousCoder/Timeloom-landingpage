        ...
        {isOpen && (
          <div className="mt-2 bg-white/90 backdrop-blur-xl border border-gray-200/20 rounded-2xl shadow-lg shadow-gray-900/10 overflow-hidden">
            <div className="px-4 py-2 space-y-1">
              ...
              <a href="https://github.com/BerrySeriousCoder/Timeloom" target="_blank" rel="noopener noreferrer" className="block text-gray-700 hover:text-blue-600 hover:bg-gray-50/50 px-3 py-2 text-sm font-medium rounded-lg transition-all duration-200 flex items-center gap-2">
                <Github size={16} />
                Open Source
              </a>
