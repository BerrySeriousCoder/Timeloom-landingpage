    ...
    <section id="features" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[200px]">
          ...
          <div className="md:col-span-2 lg:row-span-2 bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8 hover:scale-105 transition-all duration-300 group cursor-pointer border border-blue-200/50">
            <div className="h-full flex flex-col justify-between">
              <div>
                <Tag className="w-12 h-12 text-blue-600 mb-4 group-hover:scale-110 transition-transform" />
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Global Tagging System</h3>
          ...
          {/* Gantt Charts */}
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-3xl p-6 hover:scale-105 transition-all duration-300 group cursor-pointer border border-purple-200/50">
          ...
          {/* Open Source */}
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-3xl p-6 hover:scale-105 transition-all duration-300 group cursor-pointer border border-green-200/50">
          ...
          {/* Gmail Integration */}
          <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-3xl p-6 hover:scale-105 transition-all duration-300 group cursor-pointer border border-red-200/50">
          ...
          {/* Calendar Events */}
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-3xl p-6 hover:scale-105 transition-all duration-300 group cursor-pointer border border-orange-200/50">
            ...
            <p className="text-gray-600 text-sm">
              Connect Google Calendar events to your projects and tags.
            </p>
          </div>
          
          {/* Custom Dashboard - Wide card */}
          <div className="md:col-span-2 bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-3xl p-8 hover:scale-105 transition-all duration-300 group cursor-pointer border border-indigo-200/50">
            <div className="h-full flex flex-col justify-between">
              <div>
                <Layout className="w-12 h-12 text-indigo-600 mb-4 group-hover:scale-110 transition-transform" />
                <h3 className="text-2xl font-bold text-gray-900 mb-3">Custom Dashboard</h3>
                <p className="text-gray-600 leading-relaxed">
